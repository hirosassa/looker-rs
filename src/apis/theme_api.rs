...
pub async fn active_themes(configuration: &configuration::Configuration, name: Option<&str>, ts: Option<String>, fields: Option<&str>) -> Result<Vec<crate::models::Theme>, Error<ActiveThemesError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActiveThemesError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn all_themes(configuration: &configuration::Configuration, fields: Option<&str>) -> Result<Vec<crate::models::Theme>, Error<AllThemesError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AllThemesError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn create_theme(configuration: &configuration::Configuration, body: crate::models::Theme) -> Result<crate::models::Theme, Error<CreateThemeError>> {
...
pub async fn default_theme(configuration: &configuration::Configuration, ts: Option<String>) -> Result<crate::models::Theme, Error<DefaultThemeError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DefaultThemeError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn delete_theme(configuration: &configuration::Configuration, theme_id: &str) -> Result<String, Error<DeleteThemeError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/themes/{theme_id}", configuration.base_path, theme_id=crate::apis::urlencode(theme_id));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteThemeError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn search_themes(configuration: &configuration::Configuration, id: Option<i64>, name: Option<&str>, begin_at: Option<String>, end_at: Option<String>, limit: Option<i64>, offset: Option<i64>, sorts: Option<&str>, fields: Option<&str>, filter_or: Option<bool>) -> Result<Vec<crate::models::Theme>, Error<SearchThemesError>> {
    ...
    if let Some(ref local_var_str) = begin_at {
        local_var_req_builder = local_var_req_builder.query(&[("begin_at", &local_var_str.to_string())]);
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SearchThemesError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn set_default_theme(configuration: &configuration::Configuration, name: &str) -> Result<crate::models::Theme, Error<SetDefaultThemeError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SetDefaultThemeError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn theme(configuration: &configuration::Configuration, theme_id: &str, fields: Option<&str>) -> Result<crate::models::Theme, Error<ThemeError>> {
...
pub async fn theme_or_default(configuration: &configuration::Configuration, name: &str, ts: Option<String>) -> Result<crate::models::Theme, Error<ThemeOrDefaultError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ThemeOrDefaultError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn update_theme(configuration: &configuration::Configuration, theme_id: &str, body: crate::models::Theme) -> Result<crate::models::Theme, Error<UpdateThemeError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateThemeError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn validate_theme(configuration: &configuration::Configuration, body: crate::models::Theme) -> Result<crate::models::ValidationError, Error<ValidateThemeError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ValidateThemeError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
