...
pub async fn all_color_collections(
    configuration: &configuration::Configuration,
    fields: Option<&str>,
) -> Result<Vec<crate::models::ColorCollection>, Error<AllColorCollectionsError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AllColorCollectionsError> =
...
pub async fn color_collection(
    configuration: &configuration::Configuration,
    collection_id: &str,
    fields: Option<&str>,
) -> Result<crate::models::ColorCollection, Error<ColorCollectionError>> {
    let local_var_client = &configuration.client;

    let local_var_uri_str = format!(
        "{}/color_collections/{collection_id}",
        configuration.base_path,
        collection_id = crate::apis::urlencode(collection_id)
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ColorCollectionError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn color_collections_custom(
    configuration: &configuration::Configuration,
    fields: Option<&str>,
) -> Result<Vec<crate::models::ColorCollection>, Error<ColorCollectionsCustomError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ColorCollectionsCustomError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn color_collections_standard(
    configuration: &configuration::Configuration,
    fields: Option<&str>,
) -> Result<Vec<crate::models::ColorCollection>, Error<ColorCollectionsStandardError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ColorCollectionsStandardError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn create_color_collection(
    configuration: &configuration::Configuration,
    body: crate::models::ColorCollection,
) -> Result<crate::models::ColorCollection, Error<CreateColorCollectionError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateColorCollectionError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn default_color_collection(
    configuration: &configuration::Configuration,
) -> Result<crate::models::ColorCollection, Error<DefaultColorCollectionError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DefaultColorCollectionError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn delete_color_collection(
    configuration: &configuration::Configuration,
    collection_id: &str,
) -> Result<(), Error<DeleteColorCollectionError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteColorCollectionError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn set_default_color_collection(
    configuration: &configuration::Configuration,
    collection_id: &str,
) -> Result<crate::models::ColorCollection, Error<SetDefaultColorCollectionError>> {
    let local_var_client = &configuration.client;
    ...
    local_var_req_builder =
        local_var_req_builder.query(&[("collection_id", &collection_id.to_string())]);
    if let Some(ref local_var_user_agent) = configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SetDefaultColorCollectionError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_color_collection(
    configuration: &configuration::Configuration,
    collection_id: &str,
    body: crate::models::ColorCollection,
) -> Result<crate::models::ColorCollection, Error<UpdateColorCollectionError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateColorCollectionError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
