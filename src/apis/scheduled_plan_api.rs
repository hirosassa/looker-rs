...
pub async fn all_scheduled_plans(configuration: &configuration::Configuration, user_id: Option<i64>, fields: Option<&str>, all_users: Option<bool>) -> Result<Vec<crate::models::ScheduledPlan>, Error<AllScheduledPlansError>> {
    ...
    if let Some(ref local_var_str) = all_users {
        local_var_req_builder = local_var_req_builder.query(&[("all_users", &local_var_str.to_string())]);
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AllScheduledPlansError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn create_scheduled_plan(configuration: &configuration::Configuration, body: crate::models::ScheduledPlan) -> Result<crate::models::ScheduledPlan, Error<CreateScheduledPlanError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateScheduledPlanError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn delete_scheduled_plan(configuration: &configuration::Configuration, scheduled_plan_id: i64) -> Result<String, Error<DeleteScheduledPlanError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/scheduled_plans/{scheduled_plan_id}", configuration.base_path, scheduled_plan_id=scheduled_plan_id);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteScheduledPlanError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn scheduled_plan(configuration: &configuration::Configuration, scheduled_plan_id: i64, fields: Option<&str>) -> Result<crate::models::ScheduledPlan, Error<ScheduledPlanError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ScheduledPlanError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn scheduled_plan_run_once(configuration: &configuration::Configuration, body: crate::models::ScheduledPlan) -> Result<crate::models::ScheduledPlan, Error<ScheduledPlanRunOnceError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ScheduledPlanRunOnceError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn scheduled_plan_run_once_by_id(configuration: &configuration::Configuration, scheduled_plan_id: i64, body: Option<crate::models::WriteScheduledPlan>) -> Result<crate::models::ScheduledPlan, Error<ScheduledPlanRunOnceByIdError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/scheduled_plans/{scheduled_plan_id}/run_once", configuration.base_path, scheduled_plan_id=scheduled_plan_id);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ScheduledPlanRunOnceByIdError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn scheduled_plans_for_dashboard(configuration: &configuration::Configuration, dashboard_id: i64, user_id: Option<i64>, all_users: Option<bool>, fields: Option<&str>) -> Result<Vec<crate::models::ScheduledPlan>, Error<ScheduledPlansForDashboardError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/scheduled_plans/dashboard/{dashboard_id}", configuration.base_path, dashboard_id=dashboard_id);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ScheduledPlansForDashboardError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn scheduled_plans_for_look(configuration: &configuration::Configuration, look_id: i64, user_id: Option<i64>, fields: Option<&str>, all_users: Option<bool>) -> Result<Vec<crate::models::ScheduledPlan>, Error<ScheduledPlansForLookError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/scheduled_plans/look/{look_id}", configuration.base_path, look_id=look_id);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ScheduledPlansForLookError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn scheduled_plans_for_lookml_dashboard(configuration: &configuration::Configuration, lookml_dashboard_id: &str, user_id: Option<i64>, fields: Option<&str>, all_users: Option<bool>) -> Result<Vec<crate::models::ScheduledPlan>, Error<ScheduledPlansForLookmlDashboardError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/scheduled_plans/lookml_dashboard/{lookml_dashboard_id}", configuration.base_path, lookml_dashboard_id=crate::apis::urlencode(lookml_dashboard_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ScheduledPlansForLookmlDashboardError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn scheduled_plans_for_space(configuration: &configuration::Configuration, space_id: i64, fields: Option<&str>) -> Result<Vec<crate::models::ScheduledPlan>, Error<ScheduledPlansForSpaceError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/scheduled_plans/space/{space_id}", configuration.base_path, space_id=space_id);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ScheduledPlansForSpaceError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn update_scheduled_plan(configuration: &configuration::Configuration, scheduled_plan_id: i64, body: crate::models::ScheduledPlan) -> Result<crate::models::ScheduledPlan, Error<UpdateScheduledPlanError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateScheduledPlanError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
