...
/// struct for typed errors of method `all_workspaces`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum AllWorkspacesError {
    Status400(crate::models::Error),
    Status404(crate::models::Error),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method `workspace`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
pub async fn all_workspaces(configuration: &configuration::Configuration, ) -> Result<Vec<crate::models::Workspace>, Error<AllWorkspacesError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/workspaces", configuration.base_path);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AllWorkspacesError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn workspace(configuration: &configuration::Configuration, workspace_id: &str) -> Result<crate::models::Workspace, Error<WorkspaceError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/workspaces/{workspace_id}", configuration.base_path, workspace_id=crate::apis::urlencode(workspace_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<WorkspaceError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
