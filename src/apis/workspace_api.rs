...
pub async fn all_workspaces(
...
) -> Result<Vec<crate::models::Workspace>, Error<AllWorkspacesError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AllWorkspacesError> =
...
pub async fn workspace(
    configuration: &configuration::Configuration,
    workspace_id: &str,
) -> Result<crate::models::Workspace, Error<WorkspaceError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<WorkspaceError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
