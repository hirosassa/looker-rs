...
pub async fn all_running_queries(
    configuration: &configuration::Configuration,
) -> Result<Vec<crate::models::RunningQueries>, Error<AllRunningQueriesError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AllRunningQueriesError> =
...
pub async fn create_merge_query(
    configuration: &configuration::Configuration,
    fields: Option<&str>,
    body: Option<crate::models::MergeQuery>,
) -> Result<crate::models::MergeQuery, Error<CreateMergeQueryError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateMergeQueryError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn create_query(
    configuration: &configuration::Configuration,
    body: crate::models::Query,
    fields: Option<&str>,
) -> Result<crate::models::Query, Error<CreateQueryError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateQueryError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn create_query_task(
    configuration: &configuration::Configuration,
    body: crate::models::CreateQueryTask,
    limit: Option<i64>,
    ...
    fields: Option<&str>,
) -> Result<crate::models::QueryTask, Error<CreateQueryTaskError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateQueryTaskError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn create_sql_query(
    configuration: &configuration::Configuration,
    body: crate::models::SqlQueryCreate,
) -> Result<crate::models::SqlQuery, Error<CreateSqlQueryError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateSqlQueryError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn kill_query(
    configuration: &configuration::Configuration,
    query_task_id: &str,
) -> Result<String, Error<KillQueryError>> {
    let local_var_client = &configuration.client;

    let local_var_uri_str = format!(
        "{}/running_queries/{query_task_id}",
        configuration.base_path,
        query_task_id = crate::apis::urlencode(query_task_id)
    );
    let mut local_var_req_builder =
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<KillQueryError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn merge_query(
    ...
    merge_query_id: &str,
    fields: Option<&str>,
) -> Result<crate::models::MergeQuery, Error<MergeQueryError>> {
    let local_var_client = &configuration.client;

    let local_var_uri_str = format!(
        "{}/merge_queries/{merge_query_id}",
        configuration.base_path,
        merge_query_id = crate::apis::urlencode(merge_query_id)
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<MergeQueryError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn query(
    ...
    query_id: i64,
    fields: Option<&str>,
) -> Result<crate::models::Query, Error<QueryError>> {
    let local_var_client = &configuration.client;
...
pub async fn query_for_slug(
    configuration: &configuration::Configuration,
    slug: &str,
    fields: Option<&str>,
) -> Result<crate::models::Query, Error<QueryForSlugError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<QueryForSlugError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn query_task(
    ...
    query_task_id: &str,
    fields: Option<&str>,
) -> Result<crate::models::QueryTask, Error<QueryTaskError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<QueryTaskError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn query_task_multi_results(
    configuration: &configuration::Configuration,
    query_task_ids: Vec<String>,
) -> Result<::std::collections::HashMap<String, String>, Error<QueryTaskMultiResultsError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<QueryTaskMultiResultsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn query_task_results(
    configuration: &configuration::Configuration,
    query_task_id: &str,
) -> Result<String, Error<QueryTaskResultsError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<QueryTaskResultsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn run_inline_query(
    ...
    rebuild_pdts: Option<bool>,
    server_table_calcs: Option<bool>,
) -> Result<String, Error<RunInlineQueryError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RunInlineQueryError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn run_query(
    ...
    rebuild_pdts: Option<bool>,
    server_table_calcs: Option<bool>,
) -> Result<String, Error<RunQueryError>> {
    let local_var_client = &configuration.client;
...
pub async fn run_sql_query(
    ...
    result_format: &str,
    download: Option<&str>,
) -> Result<String, Error<RunSqlQueryError>> {
    let local_var_client = &configuration.client;
    ...
    if let Some(ref local_var_str) = download {
        local_var_req_builder =
            local_var_req_builder.query(&[("download", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RunSqlQueryError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn run_url_encoded_query(
    configuration: &configuration::Configuration,
    model_name: &str,
    view_name: &str,
    result_format: &str,
) -> Result<String, Error<RunUrlEncodedQueryError>> {
    let local_var_client = &configuration.client;

    let local_var_uri_str = format!(
        "{}/queries/models/{model_name}/views/{view_name}/run/{result_format}",
        configuration.base_path,
        model_name = crate::apis::urlencode(model_name),
        view_name = crate::apis::urlencode(view_name),
        result_format = crate::apis::urlencode(result_format)
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RunUrlEncodedQueryError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn sql_query(
    configuration: &configuration::Configuration,
    slug: &str,
) -> Result<crate::models::SqlQuery, Error<SqlQueryError>> {
    let local_var_client = &configuration.client;
