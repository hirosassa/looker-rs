...
pub async fn create_dashboard_render_task(
    configuration: &configuration::Configuration,
    dashboard_id: i64,
    result_format: &str,
    width: i64,
    height: i64,
    body: crate::models::CreateDashboardRenderTask,
    fields: Option<&str>,
    pdf_paper_size: Option<&str>,
    pdf_landscape: Option<bool>,
) -> Result<crate::models::RenderTask, Error<CreateDashboardRenderTaskError>> {
    ...
    if let Some(ref local_var_str) = pdf_paper_size {
        local_var_req_builder =
            local_var_req_builder.query(&[("pdf_paper_size", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = pdf_landscape {
        local_var_req_builder =
            local_var_req_builder.query(&[("pdf_landscape", &local_var_str.to_string())]);
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateDashboardRenderTaskError> =
...
pub async fn create_look_render_task(
    configuration: &configuration::Configuration,
    look_id: i64,
    result_format: &str,
    width: i64,
    height: i64,
    fields: Option<&str>,
) -> Result<crate::models::RenderTask, Error<CreateLookRenderTaskError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateLookRenderTaskError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn create_lookml_dashboard_render_task(
    configuration: &configuration::Configuration,
    dashboard_id: &str,
    result_format: &str,
    width: i64,
    ...
    pdf_paper_size: Option<&str>,
    pdf_landscape: Option<bool>,
) -> Result<crate::models::RenderTask, Error<CreateLookmlDashboardRenderTaskError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateLookmlDashboardRenderTaskError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn create_query_render_task(
    configuration: &configuration::Configuration,
    query_id: i64,
    result_format: &str,
    width: i64,
    height: i64,
    fields: Option<&str>,
) -> Result<crate::models::RenderTask, Error<CreateQueryRenderTaskError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateQueryRenderTaskError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn render_task(
    ...
    render_task_id: &str,
    fields: Option<&str>,
) -> Result<crate::models::RenderTask, Error<RenderTaskError>> {
    let local_var_client = &configuration.client;

    let local_var_uri_str = format!(
        "{}/render_tasks/{render_task_id}",
        configuration.base_path,
        render_task_id = crate::apis::urlencode(render_task_id)
    );
    let mut local_var_req_builder =
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RenderTaskError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn render_task_results(
    configuration: &configuration::Configuration,
    render_task_id: &str,
) -> Result<String, Error<RenderTaskResultsError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RenderTaskResultsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
