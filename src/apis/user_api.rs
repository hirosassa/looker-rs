...
pub async fn all_user_credentials_api3s(
    configuration: &configuration::Configuration,
    user_id: i64,
    fields: Option<&str>,
) -> Result<Vec<crate::models::CredentialsApi3>, Error<AllUserCredentialsApi3sError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AllUserCredentialsApi3sError> =
...
pub async fn all_user_credentials_embeds(
    configuration: &configuration::Configuration,
    user_id: i64,
    fields: Option<&str>,
) -> Result<Vec<crate::models::CredentialsEmbed>, Error<AllUserCredentialsEmbedsError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AllUserCredentialsEmbedsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn all_user_sessions(
    configuration: &configuration::Configuration,
    user_id: i64,
    fields: Option<&str>,
) -> Result<Vec<crate::models::Session>, Error<AllUserSessionsError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AllUserSessionsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn all_users(
    ...
    sorts: Option<&str>,
    ids: Option<Vec<i64>>,
) -> Result<Vec<crate::models::User>, Error<AllUsersError>> {
    let local_var_client = &configuration.client;
...
/// ### API 3 login information for the specified user. This is for the newer API keys that can be added for any user.
pub async fn create_user_credentials_api3(
    configuration: &configuration::Configuration,
    user_id: i64,
    fields: Option<&str>,
    body: Option<crate::models::CredentialsApi3>,
) -> Result<crate::models::CredentialsApi3, Error<CreateUserCredentialsApi3Error>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateUserCredentialsApi3Error> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn create_user_credentials_email(
    configuration: &configuration::Configuration,
    user_id: i64,
    body: crate::models::CredentialsEmail,
    fields: Option<&str>,
) -> Result<crate::models::CredentialsEmail, Error<CreateUserCredentialsEmailError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateUserCredentialsEmailError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn create_user_credentials_email_password_reset(
    configuration: &configuration::Configuration,
    user_id: i64,
    expires: Option<bool>,
    fields: Option<&str>,
) -> Result<crate::models::CredentialsEmail, Error<CreateUserCredentialsEmailPasswordResetError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateUserCredentialsEmailPasswordResetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn create_user_credentials_totp(
    configuration: &configuration::Configuration,
    user_id: i64,
    fields: Option<&str>,
    body: Option<crate::models::CredentialsTotp>,
) -> Result<crate::models::CredentialsTotp, Error<CreateUserCredentialsTotpError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateUserCredentialsTotpError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn delete_user_attribute_user_value(
    configuration: &configuration::Configuration,
    user_id: i64,
    user_attribute_id: i64,
) -> Result<(), Error<DeleteUserAttributeUserValueError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteUserAttributeUserValueError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
/// ### API 3 login information for the specified user. This is for the newer API keys that can be added for any user.
pub async fn delete_user_credentials_api3(
    configuration: &configuration::Configuration,
    user_id: i64,
    credentials_api3_id: i64,
) -> Result<String, Error<DeleteUserCredentialsApi3Error>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteUserCredentialsApi3Error> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
/// ### Email/password login information for the specified user.
pub async fn delete_user_credentials_email(
    configuration: &configuration::Configuration,
    user_id: i64,
) -> Result<String, Error<DeleteUserCredentialsEmailError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteUserCredentialsEmailError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
/// ### Embed login information for the specified user.
pub async fn delete_user_credentials_embed(
    configuration: &configuration::Configuration,
    user_id: i64,
    credentials_embed_id: i64,
) -> Result<String, Error<DeleteUserCredentialsEmbedError>> {
    let local_var_client = &configuration.client;
    ...
    let local_var_uri_str = format!(
        ...
        configuration.base_path,
        user_id = user_id,
        credentials_embed_id = credentials_embed_id
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteUserCredentialsEmbedError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn delete_user_credentials_google(
    configuration: &configuration::Configuration,
    user_id: i64,
) -> Result<String, Error<DeleteUserCredentialsGoogleError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteUserCredentialsGoogleError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn delete_user_credentials_ldap(
    configuration: &configuration::Configuration,
    user_id: i64,
) -> Result<String, Error<DeleteUserCredentialsLdapError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteUserCredentialsLdapError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn delete_user_credentials_looker_openid(
    configuration: &configuration::Configuration,
    user_id: i64,
) -> Result<String, Error<DeleteUserCredentialsLookerOpenidError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteUserCredentialsLookerOpenidError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn delete_user_credentials_oidc(
    configuration: &configuration::Configuration,
    user_id: i64,
) -> Result<String, Error<DeleteUserCredentialsOidcError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteUserCredentialsOidcError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn delete_user_credentials_saml(
    configuration: &configuration::Configuration,
    user_id: i64,
) -> Result<String, Error<DeleteUserCredentialsSamlError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteUserCredentialsSamlError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
/// ### Two-factor login information for the specified user.
pub async fn delete_user_credentials_totp(
    configuration: &configuration::Configuration,
    user_id: i64,
) -> Result<String, Error<DeleteUserCredentialsTotpError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteUserCredentialsTotpError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn delete_user_session(
    ...
    user_id: i64,
    session_id: i64,
) -> Result<String, Error<DeleteUserSessionError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteUserSessionError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn search_users(
    ...
    verified_looker_employee: Option<bool>,
    embed_user: Option<bool>,
    email: Option<&str>,
    is_disabled: Option<bool>,
    filter_or: Option<bool>,
    content_metadata_id: Option<i64>,
    group_id: Option<i64>,
) -> Result<Vec<crate::models::User>, Error<SearchUsersError>> {
    let local_var_client = &configuration.client;
    ...
    if let Some(ref local_var_str) = verified_looker_employee {
        local_var_req_builder = local_var_req_builder
            .query(&[("verified_looker_employee", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = embed_user {
        local_var_req_builder =
            local_var_req_builder.query(&[("embed_user", &local_var_str.to_string())]);
    }
    ...
    if let Some(ref local_var_str) = is_disabled {
        local_var_req_builder =
            local_var_req_builder.query(&[("is_disabled", &local_var_str.to_string())]);
    }
...
pub async fn search_users_names(
    configuration: &configuration::Configuration,
    pattern: &str,
    fields: Option<&str>,
    page: Option<i64>,
    ...
    email: Option<&str>,
    is_disabled: Option<bool>,
) -> Result<Vec<crate::models::User>, Error<SearchUsersNamesError>> {
    let local_var_client = &configuration.client;

    let local_var_uri_str = format!(
        "{}/users/search/names/{pattern}",
        configuration.base_path,
        pattern = crate::apis::urlencode(pattern)
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SearchUsersNamesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn set_user_attribute_user_value(
    configuration: &configuration::Configuration,
    user_id: i64,
    user_attribute_id: i64,
    body: crate::models::UserAttributeWithValue,
) -> Result<crate::models::UserAttributeWithValue, Error<SetUserAttributeUserValueError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SetUserAttributeUserValueError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn set_user_roles(
    ...
    body: Vec<i64>,
    fields: Option<&str>,
) -> Result<Vec<crate::models::Role>, Error<SetUserRolesError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SetUserRolesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
/// ### Email/password login information for the specified user.
pub async fn update_user_credentials_email(
    configuration: &configuration::Configuration,
    user_id: i64,
    body: crate::models::CredentialsEmail,
    fields: Option<&str>,
) -> Result<crate::models::CredentialsEmail, Error<UpdateUserCredentialsEmailError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateUserCredentialsEmailError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn user(
    ...
    user_id: i64,
    fields: Option<&str>,
) -> Result<crate::models::User, Error<UserError>> {
    let local_var_client = &configuration.client;
...
pub async fn user_attribute_user_values(
    configuration: &configuration::Configuration,
    user_id: i64,
    fields: Option<&str>,
    user_attribute_ids: Option<Vec<i64>>,
    all_values: Option<bool>,
    include_unset: Option<bool>,
) -> Result<Vec<crate::models::UserAttributeWithValue>, Error<UserAttributeUserValuesError>> {
    let local_var_client = &configuration.client;
    ...
    if let Some(ref local_var_str) = all_values {
        local_var_req_builder =
            local_var_req_builder.query(&[("all_values", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = include_unset {
        local_var_req_builder =
            local_var_req_builder.query(&[("include_unset", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UserAttributeUserValuesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
/// ### API 3 login information for the specified user. This is for the newer API keys that can be added for any user.
pub async fn user_credentials_api3(
    configuration: &configuration::Configuration,
    user_id: i64,
    credentials_api3_id: i64,
    fields: Option<&str>,
) -> Result<crate::models::CredentialsApi3, Error<UserCredentialsApi3Error>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UserCredentialsApi3Error> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
/// ### Email/password login information for the specified user.
pub async fn user_credentials_email(
    configuration: &configuration::Configuration,
    user_id: i64,
    fields: Option<&str>,
) -> Result<crate::models::CredentialsEmail, Error<UserCredentialsEmailError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UserCredentialsEmailError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
/// ### Embed login information for the specified user.
pub async fn user_credentials_embed(
    configuration: &configuration::Configuration,
    user_id: i64,
    credentials_embed_id: i64,
    fields: Option<&str>,
) -> Result<crate::models::CredentialsEmbed, Error<UserCredentialsEmbedError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UserCredentialsEmbedError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
/// ### Google authentication login information for the specified user.
pub async fn user_credentials_google(
    configuration: &configuration::Configuration,
    user_id: i64,
    fields: Option<&str>,
) -> Result<crate::models::CredentialsGoogle, Error<UserCredentialsGoogleError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UserCredentialsGoogleError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
/// ### LDAP login information for the specified user.
pub async fn user_credentials_ldap(
    configuration: &configuration::Configuration,
    user_id: i64,
    fields: Option<&str>,
) -> Result<crate::models::CredentialsLdap, Error<UserCredentialsLdapError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UserCredentialsLdapError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
/// ### Looker Openid login information for the specified user. Used by Looker Analysts.
pub async fn user_credentials_looker_openid(
    configuration: &configuration::Configuration,
    user_id: i64,
    fields: Option<&str>,
) -> Result<crate::models::CredentialsLookerOpenid, Error<UserCredentialsLookerOpenidError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UserCredentialsLookerOpenidError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
/// ### OpenID Connect (OIDC) authentication login information for the specified user.
pub async fn user_credentials_oidc(
    configuration: &configuration::Configuration,
    user_id: i64,
    fields: Option<&str>,
) -> Result<crate::models::CredentialsOidc, Error<UserCredentialsOidcError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UserCredentialsOidcError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
/// ### Saml authentication login information for the specified user.
pub async fn user_credentials_saml(
    configuration: &configuration::Configuration,
    user_id: i64,
    fields: Option<&str>,
) -> Result<crate::models::CredentialsSaml, Error<UserCredentialsSamlError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UserCredentialsSamlError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
/// ### Two-factor login information for the specified user.
pub async fn user_credentials_totp(
    configuration: &configuration::Configuration,
    user_id: i64,
    fields: Option<&str>,
) -> Result<crate::models::CredentialsTotp, Error<UserCredentialsTotpError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UserCredentialsTotpError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn user_for_credential(
    configuration: &configuration::Configuration,
    credential_type: &str,
    credential_id: &str,
    fields: Option<&str>,
) -> Result<crate::models::User, Error<UserForCredentialError>> {
    let local_var_client = &configuration.client;

    let local_var_uri_str = format!(
        "{}/users/credential/{credential_type}/{credential_id}",
        configuration.base_path,
        credential_type = crate::apis::urlencode(credential_type),
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UserForCredentialError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn user_roles(
    ...
    user_id: i64,
    fields: Option<&str>,
    direct_association_only: Option<bool>,
) -> Result<Vec<crate::models::Role>, Error<UserRolesError>> {
    let local_var_client = &configuration.client;
    ...
    if let Some(ref local_var_str) = direct_association_only {
        local_var_req_builder =
            local_var_req_builder.query(&[("direct_association_only", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UserRolesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn user_session(
    ...
    session_id: i64,
    fields: Option<&str>,
) -> Result<crate::models::Session, Error<UserSessionError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UserSessionError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
