...
pub async fn all_user_attribute_group_values(configuration: &configuration::Configuration, user_attribute_id: i64, fields: Option<&str>) -> Result<Vec<crate::models::UserAttributeGroupValue>, Error<AllUserAttributeGroupValuesError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/user_attributes/{user_attribute_id}/group_values", configuration.base_path, user_attribute_id=user_attribute_id);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AllUserAttributeGroupValuesError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn all_user_attributes(configuration: &configuration::Configuration, fields: Option<&str>, sorts: Option<&str>) -> Result<Vec<crate::models::UserAttribute>, Error<AllUserAttributesError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AllUserAttributesError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn create_user_attribute(configuration: &configuration::Configuration, body: crate::models::UserAttribute, fields: Option<&str>) -> Result<crate::models::UserAttribute, Error<CreateUserAttributeError>> {
...
pub async fn delete_user_attribute(configuration: &configuration::Configuration, user_attribute_id: i64) -> Result<String, Error<DeleteUserAttributeError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/user_attributes/{user_attribute_id}", configuration.base_path, user_attribute_id=user_attribute_id);
...
pub async fn set_user_attribute_group_values(configuration: &configuration::Configuration, user_attribute_id: i64, body: Vec<crate::models::UserAttributeGroupValue>) -> Result<Vec<crate::models::UserAttributeGroupValue>, Error<SetUserAttributeGroupValuesError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SetUserAttributeGroupValuesError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn update_user_attribute(configuration: &configuration::Configuration, user_attribute_id: i64, body: crate::models::UserAttribute, fields: Option<&str>) -> Result<crate::models::UserAttribute, Error<UpdateUserAttributeError>> {
...
pub async fn user_attribute(configuration: &configuration::Configuration, user_attribute_id: i64, fields: Option<&str>) -> Result<crate::models::UserAttribute, Error<UserAttributeError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UserAttributeError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
