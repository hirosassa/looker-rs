...
pub async fn all_model_sets(
    configuration: &configuration::Configuration,
    fields: Option<&str>,
) -> Result<Vec<crate::models::ModelSet>, Error<AllModelSetsError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AllModelSetsError> =
...
pub async fn all_permission_sets(
    configuration: &configuration::Configuration,
    fields: Option<&str>,
) -> Result<Vec<crate::models::PermissionSet>, Error<AllPermissionSetsError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AllPermissionSetsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn all_permissions(
    configuration: &configuration::Configuration,
) -> Result<Vec<crate::models::Permission>, Error<AllPermissionsError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AllPermissionsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn all_roles(
    ...
    fields: Option<&str>,
    ids: Option<Vec<i64>>,
) -> Result<Vec<crate::models::Role>, Error<AllRolesError>> {
    let local_var_client = &configuration.client;
...
pub async fn create_model_set(
    configuration: &configuration::Configuration,
    body: crate::models::ModelSet,
) -> Result<crate::models::ModelSet, Error<CreateModelSetError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateModelSetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn create_permission_set(
    configuration: &configuration::Configuration,
    body: crate::models::PermissionSet,
) -> Result<crate::models::PermissionSet, Error<CreatePermissionSetError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreatePermissionSetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn create_role(
    configuration: &configuration::Configuration,
    body: crate::models::Role,
) -> Result<crate::models::Role, Error<CreateRoleError>> {
    let local_var_client = &configuration.client;
...
pub async fn delete_model_set(
    configuration: &configuration::Configuration,
    model_set_id: i64,
) -> Result<String, Error<DeleteModelSetError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteModelSetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn delete_permission_set(
...
) -> Result<String, Error<DeletePermissionSetError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeletePermissionSetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn delete_role(
    configuration: &configuration::Configuration,
    role_id: i64,
) -> Result<String, Error<DeleteRoleError>> {
    let local_var_client = &configuration.client;
...
pub async fn model_set(
    ...
    model_set_id: i64,
    fields: Option<&str>,
) -> Result<crate::models::ModelSet, Error<ModelSetError>> {
    let local_var_client = &configuration.client;
...
pub async fn permission_set(
    ...
    permission_set_id: i64,
    fields: Option<&str>,
) -> Result<crate::models::PermissionSet, Error<PermissionSetError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PermissionSetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn role(
    configuration: &configuration::Configuration,
    role_id: i64,
) -> Result<crate::models::Role, Error<RoleError>> {
    let local_var_client = &configuration.client;
...
pub async fn role_groups(
    configuration: &configuration::Configuration,
    role_id: i64,
    fields: Option<&str>,
) -> Result<Vec<crate::models::Group>, Error<RoleGroupsError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RoleGroupsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn role_users(
...
) -> Result<Vec<crate::models::User>, Error<RoleUsersError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RoleUsersError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn search_model_sets(
    configuration: &configuration::Configuration,
    fields: Option<&str>,
    limit: Option<i64>,
    offset: Option<i64>,
...
) -> Result<Vec<crate::models::ModelSet>, Error<SearchModelSetsError>> {
    let local_var_client = &configuration.client;
    ...
    if let Some(ref local_var_str) = all_access {
        local_var_req_builder =
            local_var_req_builder.query(&[("all_access", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = built_in {
        local_var_req_builder =
            local_var_req_builder.query(&[("built_in", &local_var_str.to_string())]);
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SearchModelSetsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn search_permission_sets(
    configuration: &configuration::Configuration,
    fields: Option<&str>,
    limit: Option<i64>,
    offset: Option<i64>,
    ...
    built_in: Option<bool>,
    filter_or: Option<bool>,
) -> Result<Vec<crate::models::PermissionSet>, Error<SearchPermissionSetsError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SearchPermissionSetsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn search_roles(
    ...
    built_in: Option<bool>,
    filter_or: Option<bool>,
) -> Result<Vec<crate::models::Role>, Error<SearchRolesError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SearchRolesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn set_role_groups(
    configuration: &configuration::Configuration,
    role_id: i64,
    body: Vec<i64>,
) -> Result<Vec<crate::models::Group>, Error<SetRoleGroupsError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SetRoleGroupsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn set_role_users(
    ...
    role_id: i64,
    body: Vec<i64>,
) -> Result<Vec<crate::models::User>, Error<SetRoleUsersError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SetRoleUsersError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_model_set(
    ...
    model_set_id: i64,
    body: crate::models::ModelSet,
) -> Result<crate::models::ModelSet, Error<UpdateModelSetError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateModelSetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_permission_set(
    ...
    permission_set_id: i64,
    body: crate::models::PermissionSet,
) -> Result<crate::models::PermissionSet, Error<UpdatePermissionSetError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdatePermissionSetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_role(
    ...
    role_id: i64,
    body: crate::models::Role,
) -> Result<crate::models::Role, Error<UpdateRoleError>> {
    let local_var_client = &configuration.client;
