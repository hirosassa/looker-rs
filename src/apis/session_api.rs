...
pub async fn session(configuration: &configuration::Configuration, ) -> Result<crate::models::ApiSession, Error<SessionError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SessionError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn update_session(configuration: &configuration::Configuration, body: crate::models::ApiSession) -> Result<crate::models::ApiSession, Error<UpdateSessionError>> {
