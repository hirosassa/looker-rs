...
) -> Result<crate::models::ApiSession, Error<SessionError>> {
...
pub async fn update_session(
    configuration: &configuration::Configuration,
    body: crate::models::ApiSession,
) -> Result<crate::models::ApiSession, Error<UpdateSessionError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateSessionError> =
