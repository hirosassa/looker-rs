...
pub async fn all_git_branches(configuration: &configuration::Configuration, project_id: &str) -> Result<Vec<crate::models::GitBranch>, Error<AllGitBranchesError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/projects/{project_id}/git_branches", configuration.base_path, project_id=crate::apis::urlencode(project_id));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AllGitBranchesError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn all_git_connection_tests(configuration: &configuration::Configuration, project_id: &str, remote_url: Option<&str>) -> Result<Vec<crate::models::GitConnectionTest>, Error<AllGitConnectionTestsError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/projects/{project_id}/git_connection_tests", configuration.base_path, project_id=crate::apis::urlencode(project_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());

    if let Some(ref local_var_str) = remote_url {
        local_var_req_builder = local_var_req_builder.query(&[("remote_url", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = configuration.user_agent {
        local_var_req_builder = local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AllGitConnectionTestsError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn all_lookml_tests(configuration: &configuration::Configuration, project_id: &str, file_id: Option<&str>) -> Result<Vec<crate::models::LookmlTest>, Error<AllLookmlTestsError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/projects/{project_id}/lookml_tests", configuration.base_path, project_id=crate::apis::urlencode(project_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AllLookmlTestsError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn all_project_files(configuration: &configuration::Configuration, project_id: &str, fields: Option<&str>) -> Result<Vec<crate::models::ProjectFile>, Error<AllProjectFilesError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/projects/{project_id}/files", configuration.base_path, project_id=crate::apis::urlencode(project_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AllProjectFilesError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn all_projects(configuration: &configuration::Configuration, fields: Option<&str>) -> Result<Vec<crate::models::Project>, Error<AllProjectsError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AllProjectsError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn create_git_branch(configuration: &configuration::Configuration, project_id: &str, body: crate::models::GitBranch) -> Result<crate::models::GitBranch, Error<CreateGitBranchError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/projects/{project_id}/git_branch", configuration.base_path, project_id=crate::apis::urlencode(project_id));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateGitBranchError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn create_git_deploy_key(configuration: &configuration::Configuration, project_id: &str) -> Result<String, Error<CreateGitDeployKeyError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/projects/{project_id}/git/deploy_key", configuration.base_path, project_id=crate::apis::urlencode(project_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateGitDeployKeyError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn create_project(configuration: &configuration::Configuration, body: crate::models::Project) -> Result<crate::models::Project, Error<CreateProjectError>> {
...
pub async fn delete_git_branch(configuration: &configuration::Configuration, project_id: &str, branch_name: &str) -> Result<String, Error<DeleteGitBranchError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/projects/{project_id}/git_branch/{branch_name}", configuration.base_path, project_id=crate::apis::urlencode(project_id), branch_name=crate::apis::urlencode(branch_name));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteGitBranchError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn delete_repository_credential(configuration: &configuration::Configuration, root_project_id: &str, credential_id: &str) -> Result<String, Error<DeleteRepositoryCredentialError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/projects/{root_project_id}/credential/{credential_id}", configuration.base_path, root_project_id=crate::apis::urlencode(root_project_id), credential_id=crate::apis::urlencode(credential_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteRepositoryCredentialError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn deploy_ref_to_production(configuration: &configuration::Configuration, project_id: &str, branch: Option<&str>, _ref: Option<&str>) -> Result<String, Error<DeployRefToProductionError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/projects/{project_id}/deploy_ref_to_production", configuration.base_path, project_id=crate::apis::urlencode(project_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeployRefToProductionError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn deploy_to_production(configuration: &configuration::Configuration, project_id: &str) -> Result<String, Error<DeployToProductionError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/projects/{project_id}/deploy_to_production", configuration.base_path, project_id=crate::apis::urlencode(project_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeployToProductionError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn find_git_branch(configuration: &configuration::Configuration, project_id: &str, branch_name: &str) -> Result<crate::models::GitBranch, Error<FindGitBranchError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<FindGitBranchError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn get_all_repository_credentials(configuration: &configuration::Configuration, root_project_id: &str) -> Result<Vec<crate::models::RepositoryCredential>, Error<GetAllRepositoryCredentialsError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/projects/{root_project_id}/credentials", configuration.base_path, root_project_id=crate::apis::urlencode(root_project_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetAllRepositoryCredentialsError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn git_branch(configuration: &configuration::Configuration, project_id: &str) -> Result<crate::models::GitBranch, Error<GitBranchError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GitBranchError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn git_deploy_key(configuration: &configuration::Configuration, project_id: &str) -> Result<String, Error<GitDeployKeyError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GitDeployKeyError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn manifest(configuration: &configuration::Configuration, project_id: &str) -> Result<crate::models::Manifest, Error<ManifestError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/projects/{project_id}/manifest", configuration.base_path, project_id=crate::apis::urlencode(project_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn project(configuration: &configuration::Configuration, project_id: &str, fields: Option<&str>) -> Result<crate::models::Project, Error<ProjectError>> {
...
pub async fn project_file(configuration: &configuration::Configuration, project_id: &str, file_id: &str, fields: Option<&str>) -> Result<crate::models::ProjectFile, Error<ProjectFileError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/projects/{project_id}/files/file", configuration.base_path, project_id=crate::apis::urlencode(project_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ProjectFileError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn project_validation_results(configuration: &configuration::Configuration, project_id: &str, fields: Option<&str>) -> Result<crate::models::ProjectValidationCache, Error<ProjectValidationResultsError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/projects/{project_id}/validate", configuration.base_path, project_id=crate::apis::urlencode(project_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ProjectValidationResultsError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn project_workspace(configuration: &configuration::Configuration, project_id: &str, fields: Option<&str>) -> Result<crate::models::ProjectWorkspace, Error<ProjectWorkspaceError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/projects/{project_id}/current_workspace", configuration.base_path, project_id=crate::apis::urlencode(project_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ProjectWorkspaceError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn reset_project_to_production(configuration: &configuration::Configuration, project_id: &str) -> Result<String, Error<ResetProjectToProductionError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/projects/{project_id}/reset_to_production", configuration.base_path, project_id=crate::apis::urlencode(project_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ResetProjectToProductionError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn reset_project_to_remote(configuration: &configuration::Configuration, project_id: &str) -> Result<String, Error<ResetProjectToRemoteError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/projects/{project_id}/reset_to_remote", configuration.base_path, project_id=crate::apis::urlencode(project_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ResetProjectToRemoteError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn run_git_connection_test(configuration: &configuration::Configuration, project_id: &str, test_id: &str, remote_url: Option<&str>, use_production: Option<&str>) -> Result<crate::models::GitConnectionTestResult, Error<RunGitConnectionTestError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/projects/{project_id}/git_connection_tests/{test_id}", configuration.base_path, project_id=crate::apis::urlencode(project_id), test_id=crate::apis::urlencode(test_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if let Some(ref local_var_str) = use_production {
        local_var_req_builder = local_var_req_builder.query(&[("use_production", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = configuration.user_agent {
        local_var_req_builder = local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RunGitConnectionTestError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn run_lookml_test(configuration: &configuration::Configuration, project_id: &str, file_id: Option<&str>, test: Option<&str>, model: Option<&str>) -> Result<Vec<crate::models::LookmlTestResult>, Error<RunLookmlTestError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/projects/{project_id}/lookml_tests/run", configuration.base_path, project_id=crate::apis::urlencode(project_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RunLookmlTestError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn tag_ref(configuration: &configuration::Configuration, project_id: &str, body: crate::models::Project, commit_sha: Option<&str>, tag_name: Option<&str>, tag_message: Option<&str>) -> Result<crate::models::Project, Error<TagRefError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/projects/{project_id}/tag", configuration.base_path, project_id=crate::apis::urlencode(project_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());

    if let Some(ref local_var_str) = commit_sha {
        local_var_req_builder = local_var_req_builder.query(&[("commit_sha", &local_var_str.to_string())]);
    }
    ...
    if let Some(ref local_var_str) = tag_message {
        local_var_req_builder = local_var_req_builder.query(&[("tag_message", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = configuration.user_agent {
        local_var_req_builder = local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    }
...
pub async fn update_git_branch(configuration: &configuration::Configuration, project_id: &str, body: crate::models::GitBranch) -> Result<crate::models::GitBranch, Error<UpdateGitBranchError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateGitBranchError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn update_project(configuration: &configuration::Configuration, project_id: &str, body: crate::models::Project, fields: Option<&str>) -> Result<crate::models::Project, Error<UpdateProjectError>> {
...
pub async fn update_repository_credential(configuration: &configuration::Configuration, root_project_id: &str, credential_id: &str, body: crate::models::RepositoryCredential) -> Result<crate::models::RepositoryCredential, Error<UpdateRepositoryCredentialError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateRepositoryCredentialError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn validate_project(configuration: &configuration::Configuration, project_id: &str, fields: Option<&str>) -> Result<crate::models::ProjectValidation, Error<ValidateProjectError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ValidateProjectError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
