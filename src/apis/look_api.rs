...
pub async fn all_looks(configuration: &configuration::Configuration, fields: Option<&str>) -> Result<Vec<crate::models::Look>, Error<AllLooksError>> {
...
pub async fn create_look(configuration: &configuration::Configuration, body: crate::models::LookWithQuery, fields: Option<&str>) -> Result<crate::models::LookWithQuery, Error<CreateLookError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateLookError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn delete_look(configuration: &configuration::Configuration, look_id: i64) -> Result<String, Error<DeleteLookError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/looks/{look_id}", configuration.base_path, look_id=look_id);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteLookError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn look(configuration: &configuration::Configuration, look_id: i64, fields: Option<&str>) -> Result<crate::models::LookWithQuery, Error<LookError>> {
...
pub async fn run_look(configuration: &configuration::Configuration, look_id: i64, result_format: &str, limit: Option<i64>, apply_formatting: Option<bool>, apply_vis: Option<bool>, cache: Option<bool>, image_width: Option<i64>, image_height: Option<i64>, generate_drill_links: Option<bool>, force_production: Option<bool>, cache_only: Option<bool>, path_prefix: Option<&str>, rebuild_pdts: Option<bool>, server_table_calcs: Option<bool>) -> Result<String, Error<RunLookError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/looks/{look_id}/run/{result_format}", configuration.base_path, look_id=look_id, result_format=crate::apis::urlencode(result_format));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn search_looks(configuration: &configuration::Configuration, id: Option<&str>, title: Option<&str>, description: Option<&str>, content_favorite_id: Option<i64>, space_id: Option<&str>, user_id: Option<&str>, view_count: Option<&str>, deleted: Option<bool>, query_id: Option<i64>, curate: Option<bool>, fields: Option<&str>, page: Option<i64>, per_page: Option<i64>, limit: Option<i64>, offset: Option<i64>, sorts: Option<&str>, filter_or: Option<bool>) -> Result<Vec<crate::models::Look>, Error<SearchLooksError>> {
    ...
    if let Some(ref local_var_str) = query_id {
        local_var_req_builder = local_var_req_builder.query(&[("query_id", &local_var_str.to_string())]);
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SearchLooksError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn update_look(configuration: &configuration::Configuration, look_id: i64, body: crate::models::LookWithQuery, fields: Option<&str>) -> Result<crate::models::LookWithQuery, Error<UpdateLookError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateLookError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
