...
pub async fn all_user_login_lockouts(
    configuration: &configuration::Configuration,
    fields: Option<&str>,
) -> Result<Vec<crate::models::UserLoginLockout>, Error<AllUserLoginLockoutsError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AllUserLoginLockoutsError> =
...
pub async fn create_oidc_test_config(
    configuration: &configuration::Configuration,
    body: crate::models::OidcConfig,
) -> Result<crate::models::OidcConfig, Error<CreateOidcTestConfigError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateOidcTestConfigError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn create_saml_test_config(
    configuration: &configuration::Configuration,
    body: crate::models::SamlConfig,
) -> Result<crate::models::SamlConfig, Error<CreateSamlTestConfigError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateSamlTestConfigError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn create_sso_embed_url(
    configuration: &configuration::Configuration,
    body: crate::models::EmbedSsoParams,
) -> Result<crate::models::EmbedUrlResponse, Error<CreateSsoEmbedUrlError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateSsoEmbedUrlError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn delete_oidc_test_config(
    configuration: &configuration::Configuration,
    test_slug: &str,
) -> Result<String, Error<DeleteOidcTestConfigError>> {
    let local_var_client = &configuration.client;

    let local_var_uri_str = format!(
        "{}/oidc_test_configs/{test_slug}",
        configuration.base_path,
        test_slug = crate::apis::urlencode(test_slug)
    );
    let mut local_var_req_builder =
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteOidcTestConfigError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn delete_saml_test_config(
    configuration: &configuration::Configuration,
    test_slug: &str,
) -> Result<String, Error<DeleteSamlTestConfigError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteSamlTestConfigError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn delete_user_login_lockout(
    configuration: &configuration::Configuration,
    key: &str,
) -> Result<String, Error<DeleteUserLoginLockoutError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteUserLoginLockoutError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn fetch_and_parse_saml_idp_metadata(
    configuration: &configuration::Configuration,
    body: &str,
) -> Result<crate::models::SamlMetadataParseResult, Error<FetchAndParseSamlIdpMetadataError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<FetchAndParseSamlIdpMetadataError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn force_password_reset_at_next_login_for_all_users(
    configuration: &configuration::Configuration,
) -> Result<String, Error<ForcePasswordResetAtNextLoginForAllUsersError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ForcePasswordResetAtNextLoginForAllUsersError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn ldap_config(
    configuration: &configuration::Configuration,
) -> Result<crate::models::LdapConfig, Error<LdapConfigError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<LdapConfigError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn oidc_config(
    configuration: &configuration::Configuration,
) -> Result<crate::models::OidcConfig, Error<OidcConfigError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OidcConfigError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn oidc_test_config(
    configuration: &configuration::Configuration,
    test_slug: &str,
) -> Result<crate::models::OidcConfig, Error<OidcTestConfigError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OidcTestConfigError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn parse_saml_idp_metadata(
    configuration: &configuration::Configuration,
    body: &str,
) -> Result<crate::models::SamlMetadataParseResult, Error<ParseSamlIdpMetadataError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ParseSamlIdpMetadataError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
/// ### Get password config.
pub async fn password_config(
    configuration: &configuration::Configuration,
) -> Result<crate::models::PasswordConfig, Error<PasswordConfigError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PasswordConfigError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn saml_config(
    configuration: &configuration::Configuration,
) -> Result<crate::models::SamlConfig, Error<SamlConfigError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SamlConfigError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn saml_test_config(
    configuration: &configuration::Configuration,
    test_slug: &str,
) -> Result<crate::models::SamlConfig, Error<SamlTestConfigError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SamlTestConfigError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn search_user_login_lockouts(
    configuration: &configuration::Configuration,
    fields: Option<&str>,
    page: Option<i64>,
    per_page: Option<i64>,
...
) -> Result<Vec<crate::models::UserLoginLockout>, Error<SearchUserLoginLockoutsError>> {
    let local_var_client = &configuration.client;
    ...
    if let Some(ref local_var_str) = full_name {
        local_var_req_builder =
            local_var_req_builder.query(&[("full_name", &local_var_str.to_string())]);
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SearchUserLoginLockoutsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn session_config(
    configuration: &configuration::Configuration,
) -> Result<crate::models::SessionConfig, Error<SessionConfigError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SessionConfigError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn test_ldap_config_auth(
    configuration: &configuration::Configuration,
    body: crate::models::LdapConfig,
) -> Result<crate::models::LdapConfigTestResult, Error<TestLdapConfigAuthError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TestLdapConfigAuthError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn test_ldap_config_connection(
    configuration: &configuration::Configuration,
    body: crate::models::LdapConfig,
) -> Result<crate::models::LdapConfigTestResult, Error<TestLdapConfigConnectionError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TestLdapConfigConnectionError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn test_ldap_config_user_auth(
    configuration: &configuration::Configuration,
    body: crate::models::LdapConfig,
) -> Result<crate::models::LdapConfigTestResult, Error<TestLdapConfigUserAuthError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TestLdapConfigUserAuthError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn test_ldap_config_user_info(
    configuration: &configuration::Configuration,
    body: crate::models::LdapConfig,
) -> Result<crate::models::LdapConfigTestResult, Error<TestLdapConfigUserInfoError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TestLdapConfigUserInfoError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_ldap_config(
    configuration: &configuration::Configuration,
    body: crate::models::LdapConfig,
) -> Result<crate::models::LdapConfig, Error<UpdateLdapConfigError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateLdapConfigError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_oidc_config(
    configuration: &configuration::Configuration,
    body: crate::models::OidcConfig,
) -> Result<crate::models::OidcConfig, Error<UpdateOidcConfigError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateOidcConfigError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_password_config(
    configuration: &configuration::Configuration,
    body: crate::models::PasswordConfig,
) -> Result<crate::models::PasswordConfig, Error<UpdatePasswordConfigError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdatePasswordConfigError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_saml_config(
    configuration: &configuration::Configuration,
    body: crate::models::SamlConfig,
) -> Result<crate::models::SamlConfig, Error<UpdateSamlConfigError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateSamlConfigError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_session_config(
    configuration: &configuration::Configuration,
    body: crate::models::SessionConfig,
) -> Result<crate::models::SessionConfig, Error<UpdateSessionConfigError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateSessionConfigError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
