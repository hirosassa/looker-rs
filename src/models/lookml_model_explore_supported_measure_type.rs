...
pub struct LookmlModelExploreSupportedMeasureType {
    #[serde(rename = "dimension_type", skip_serializing_if = "Option::is_none")]
    pub dimension_type: Option<String>,
    #[serde(rename = "measure_types", skip_serializing_if = "Option::is_none")]
    pub measure_types: Option<Vec<String>>,
}

impl LookmlModelExploreSupportedMeasureType {
    pub fn new() -> LookmlModelExploreSupportedMeasureType {
