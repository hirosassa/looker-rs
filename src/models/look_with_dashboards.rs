...
pub struct LookWithDashboards {
    ...
    #[serde(rename = "google_spreadsheet_formula", skip_serializing_if = "Option::is_none")]
    ...
    pub dashboards: Option<Vec<crate::models::DashboardBase>>,
}

impl LookWithDashboards {
    pub fn new() -> LookWithDashboards {
        LookWithDashboards {
            can: None,
