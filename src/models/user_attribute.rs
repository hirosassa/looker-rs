...
pub struct UserAttribute {
    ...
    #[serde(rename = "is_permanent", skip_serializing_if = "Option::is_none")]
    pub is_permanent: Option<bool>,
    /// If true, users will not be able to view values of this attribute
    #[serde(rename = "value_is_hidden", skip_serializing_if = "Option::is_none")]
    pub value_is_hidden: Option<bool>,
    /// Non-admin users can see the values of their attributes and use them in filters
    #[serde(rename = "user_can_view", skip_serializing_if = "Option::is_none")]
    pub user_can_view: Option<bool>,
    /// Users can change the value of this attribute for themselves
    #[serde(rename = "user_can_edit", skip_serializing_if = "Option::is_none")]
    pub user_can_edit: Option<bool>,
    /// Destinations to which a hidden attribute may be sent. Once set, cannot be edited.
    #[serde(rename = "hidden_value_domain_whitelist", skip_serializing_if = "Option::is_none")]
    pub hidden_value_domain_whitelist: Option<String>,
}
...
impl UserAttribute {
    pub fn new() -> UserAttribute {
        UserAttribute {
            ...
            is_system: None,
            is_permanent: None,
            value_is_hidden: None,
            user_can_view: None,
            user_can_edit: None,
            hidden_value_domain_whitelist: None,
        }
    }
}
