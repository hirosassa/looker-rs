...
pub struct IntegrationParam {
    ...
    #[serde(rename = "has_value", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "user_attribute_name", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "per_user", skip_serializing_if = "Option::is_none")]
    pub per_user: Option<bool>,
    /// When present, the param represents the oauth url the user will be taken to.
    #[serde(rename = "delegate_oauth_url", skip_serializing_if = "Option::is_none")]
    pub delegate_oauth_url: Option<String>,
}

impl IntegrationParam {
    pub fn new() -> IntegrationParam {
        IntegrationParam {
            name: None,
            label: None,
            description: None,
