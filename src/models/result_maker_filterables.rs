...
pub struct ResultMakerFilterables {
    ...
    pub listen: Option<Vec<crate::models::ResultMakerFilterablesListen>>,
}

impl ResultMakerFilterables {
    pub fn new() -> ResultMakerFilterables {
