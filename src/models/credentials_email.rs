...
pub struct CredentialsEmail {
    ...
    #[serde(rename = "forced_password_reset_at_next_login", skip_serializing_if = "Option::is_none")]
    pub forced_password_reset_at_next_login: Option<bool>,
    /// Has this credential been disabled?
    #[serde(rename = "is_disabled", skip_serializing_if = "Option::is_none")]
    pub is_disabled: Option<bool>,
    /// Timestamp for most recent login using credential
    #[serde(rename = "logged_in_at", skip_serializing_if = "Option::is_none")]
    pub logged_in_at: Option<String>,
    /// Url with one-time use secret token that the user can use to reset password
    #[serde(rename = "password_reset_url", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "user_url", skip_serializing_if = "Option::is_none")]
    pub user_url: Option<String>,
}

impl CredentialsEmail {
    pub fn new() -> CredentialsEmail {
        CredentialsEmail {
            can: None,
            created_at: None,
            email: None,
            forced_password_reset_at_next_login: None,
            is_disabled: None,
            logged_in_at: None,
