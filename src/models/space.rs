...
pub struct Space {
    ...
    #[serde(rename = "is_embed_shared_root", skip_serializing_if = "Option::is_none")]
    pub is_embed_shared_root: Option<bool>,
    /// Space is the root embed users space
    #[serde(rename = "is_embed_users_root", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "is_personal_descendant", skip_serializing_if = "Option::is_none")]
    ...
    /// Looks
    #[serde(rename = "looks", skip_serializing_if = "Option::is_none")]
    pub looks: Option<Vec<crate::models::LookWithDashboards>>,
}
