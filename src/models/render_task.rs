...
pub struct RenderTask {
    ...
    #[serde(rename = "dashboard_style", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "query_runtime", skip_serializing_if = "Option::is_none")]
    pub query_runtime: Option<f64>,
    /// Number of seconds elapsed rendering data
    #[serde(rename = "render_runtime", skip_serializing_if = "Option::is_none")]
    pub render_runtime: Option<f64>,
