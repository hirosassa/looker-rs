...
pub struct LookmlModelExploreError {
    /// Error Message
    ...
    #[serde(rename = "error_pos", skip_serializing_if = "Option::is_none")]
    pub error_pos: Option<String>,
    /// Is this a field error
    #[serde(rename = "field_error", skip_serializing_if = "Option::is_none")]
    pub field_error: Option<bool>,
}

impl LookmlModelExploreError {
    pub fn new() -> LookmlModelExploreError {
