...
pub struct ProjectValidationCache {
    ...
    pub errors: Option<Vec<crate::models::ProjectError>>,
    /// A hash value computed from the project's current state
    #[serde(rename = "project_digest", skip_serializing_if = "Option::is_none")]
    pub project_digest: Option<String>,
    /// A list of models which were not fully validated
    #[serde(rename = "models_not_validated", skip_serializing_if = "Option::is_none")]
    pub models_not_validated: Option<Vec<crate::models::ModelsNotValidated>>,
...
impl ProjectValidationCache {
    pub fn new() -> ProjectValidationCache {
        ProjectValidationCache {
            errors: None,
            project_digest: None,
            models_not_validated: None,
