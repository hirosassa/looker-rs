...
pub struct DataActionForm {
    #[serde(rename = "state", skip_serializing_if = "Option::is_none")]
    pub state: Option<Box<crate::models::DataActionUserState>>,
    /// Array of form fields.
    #[serde(rename = "fields", skip_serializing_if = "Option::is_none")]
    pub fields: Option<Vec<crate::models::DataActionFormField>>,
}

impl DataActionForm {
    pub fn new() -> DataActionForm {
        DataActionForm {
            state: None,
            fields: None,
        }
