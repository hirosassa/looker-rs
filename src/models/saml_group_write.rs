...
pub struct SamlGroupWrite {
    /// Unique Id
    #[serde(rename = "id", skip_serializing_if = "Option::is_none")]
    pub id: Option<i64>,
    /// Unique Id of group in Looker
    #[serde(rename = "looker_group_id", skip_serializing_if = "Option::is_none")]
    pub looker_group_id: Option<i64>,
    /// Name of group in Looker
    #[serde(rename = "looker_group_name", skip_serializing_if = "Option::is_none")]
    pub looker_group_name: Option<String>,
...
impl SamlGroupWrite {
    pub fn new() -> SamlGroupWrite {
        SamlGroupWrite {
            id: None,
            looker_group_id: None,
            looker_group_name: None,
            name: None,
            role_ids: None,
            url: None,
        }
