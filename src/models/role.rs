...
pub struct Role {
    ...
    #[serde(rename = "permission_set", skip_serializing_if = "Option::is_none")]
    pub permission_set: Option<Box<crate::models::PermissionSet>>,
    /// (Write-Only) Id of permission set
    #[serde(rename = "permission_set_id", skip_serializing_if = "Option::is_none")]
    pub permission_set_id: Option<i64>,
    #[serde(rename = "model_set", skip_serializing_if = "Option::is_none")]
    pub model_set: Option<Box<crate::models::ModelSet>>,
    /// (Write-Only) Id of model set
    #[serde(rename = "model_set_id", skip_serializing_if = "Option::is_none")]
    pub model_set_id: Option<i64>,
