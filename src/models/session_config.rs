...
pub struct SessionConfig {
    ...
    #[serde(rename = "allow_persistent_sessions", skip_serializing_if = "Option::is_none")]
    pub allow_persistent_sessions: Option<bool>,
    /// Number of minutes for user sessions.  Must be between 5 and 43200
    #[serde(rename = "session_minutes", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "unlimited_sessions_per_user", skip_serializing_if = "Option::is_none")]
    pub unlimited_sessions_per_user: Option<bool>,
    /// Enforce session logout for sessions that are inactive for 15 minutes.
    #[serde(rename = "use_inactivity_based_logout", skip_serializing_if = "Option::is_none")]
    pub use_inactivity_based_logout: Option<bool>,
    /// Track location of session when user logs in.
    #[serde(rename = "track_session_location", skip_serializing_if = "Option::is_none")]
    pub track_session_location: Option<bool>,
}
...
impl SessionConfig {
    pub fn new() -> SessionConfig {
        SessionConfig {
            can: None,
            allow_persistent_sessions: None,
            session_minutes: None,
            unlimited_sessions_per_user: None,
            use_inactivity_based_logout: None,
            track_session_location: None,
        }
    }
}
