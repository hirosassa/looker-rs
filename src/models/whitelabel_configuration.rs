...
pub struct WhitelabelConfiguration {
    ...
    #[serde(rename = "show_email_sub_options", skip_serializing_if = "Option::is_none")]
    pub show_email_sub_options: Option<bool>,
    /// Boolean to toggle mentions of Looker in emails
    #[serde(rename = "allow_looker_mentions", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "custom_welcome_email_advanced", skip_serializing_if = "Option::is_none")]
