...
pub struct CredentialsSaml {
    ...
    #[serde(rename = "saml_user_id", skip_serializing_if = "Option::is_none")]
    pub saml_user_id: Option<String>,
...
impl CredentialsSaml {
    pub fn new() -> CredentialsSaml {
        CredentialsSaml {
            can: None,
            created_at: None,
            email: None,
