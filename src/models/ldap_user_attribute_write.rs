...
pub struct LdapUserAttributeWrite {
    ...
    #[serde(rename = "user_attribute_ids", skip_serializing_if = "Option::is_none")]
    pub user_attribute_ids: Option<Vec<i64>>,
    /// Link to ldap config
    #[serde(rename = "url", skip_serializing_if = "Option::is_none")]
    pub url: Option<String>,
}

impl LdapUserAttributeWrite {
    pub fn new() -> LdapUserAttributeWrite {
        LdapUserAttributeWrite {
            name: None,
            required: None,
            user_attribute_ids: None,
            url: None,
        }
    }
}
