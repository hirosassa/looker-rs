...
pub struct RepositoryCredential {
    ...
    /// Root project Id
    #[serde(rename = "root_project_id", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "is_configured", skip_serializing_if = "Option::is_none")]
    pub is_configured: Option<bool>,
}

impl RepositoryCredential {
    pub fn new() -> RepositoryCredential {
