...
pub struct DashboardAggregateTableLookml {
    /// Dashboard Id
    #[serde(rename = "dashboard_id", skip_serializing_if = "Option::is_none")]
    pub dashboard_id: Option<String>,
    /// Aggregate Table LookML
    #[serde(rename = "aggregate_table_lookml", skip_serializing_if = "Option::is_none")]
    pub aggregate_table_lookml: Option<String>,
}

impl DashboardAggregateTableLookml {
    pub fn new() -> DashboardAggregateTableLookml {
        DashboardAggregateTableLookml {
            dashboard_id: None,
            aggregate_table_lookml: None,
        }
    }
}
