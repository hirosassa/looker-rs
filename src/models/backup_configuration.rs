...
pub struct BackupConfiguration {
    ...
    #[serde(rename = "custom_s3_bucket", skip_serializing_if = "Option::is_none")]
    pub custom_s3_bucket: Option<String>,
    /// Name of region where the bucket is located
    #[serde(rename = "custom_s3_bucket_region", skip_serializing_if = "Option::is_none")]
    pub custom_s3_bucket_region: Option<String>,
    /// (Write-Only) AWS S3 key used for custom-s3 backups
    #[serde(rename = "custom_s3_key", skip_serializing_if = "Option::is_none")]
    pub custom_s3_key: Option<String>,
    /// (Write-Only) AWS S3 secret used for custom-s3 backups
    #[serde(rename = "custom_s3_secret", skip_serializing_if = "Option::is_none")]
    pub custom_s3_secret: Option<String>,
...
impl BackupConfiguration {
    pub fn new() -> BackupConfiguration {
        BackupConfiguration {
            can: None,
            _type: None,
            custom_s3_bucket: None,
            custom_s3_bucket_region: None,
            custom_s3_key: None,
            custom_s3_secret: None,
            url: None,
        }
    }
}
