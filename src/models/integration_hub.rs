...
pub struct IntegrationHub {
    ...
    #[serde(rename = "fetch_error_message", skip_serializing_if = "Option::is_none")]
    pub fetch_error_message: Option<String>,
    ...
    #[serde(rename = "has_authorization_token", skip_serializing_if = "Option::is_none")]
    pub has_authorization_token: Option<bool>,
    /// Whether the legal agreement message has been signed by the user. This only matters if legal_agreement_required is true.
    #[serde(rename = "legal_agreement_signed", skip_serializing_if = "Option::is_none")]
    pub legal_agreement_signed: Option<bool>,
    /// Whether the legal terms for the integration hub are required before use.
    #[serde(rename = "legal_agreement_required", skip_serializing_if = "Option::is_none")]
    pub legal_agreement_required: Option<bool>,
    /// The legal agreement text for this integration hub.
    #[serde(rename = "legal_agreement_text", skip_serializing_if = "Option::is_none")]
    pub legal_agreement_text: Option<String>,
}

impl IntegrationHub {
    pub fn new() -> IntegrationHub {
        IntegrationHub {
            can: None,
            id: None,
            url: None,
            ...
            has_authorization_token: None,
            legal_agreement_signed: None,
            legal_agreement_required: None,
            legal_agreement_text: None,
        }
    }
}
