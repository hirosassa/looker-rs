...
pub struct CredentialsLookerOpenid {
    ...
    #[serde(rename = "logged_in_ip", skip_serializing_if = "Option::is_none")]
    pub logged_in_ip: Option<String>,
...
impl CredentialsLookerOpenid {
    pub fn new() -> CredentialsLookerOpenid {
