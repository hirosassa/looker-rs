...
pub struct LookmlModel {
    ...
    #[serde(rename = "allowed_db_connection_names", skip_serializing_if = "Option::is_none")]
    pub allowed_db_connection_names: Option<Vec<String>>,
    /// Array of explores (if has_content)
    #[serde(rename = "explores", skip_serializing_if = "Option::is_none")]
    pub explores: Option<Vec<crate::models::LookmlModelNavExplore>>,
    /// Does this model declaration have have lookml content?
    #[serde(rename = "has_content", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "unlimited_db_connections", skip_serializing_if = "Option::is_none")]
    pub unlimited_db_connections: Option<bool>,
}

impl LookmlModel {
    pub fn new() -> LookmlModel {
        LookmlModel {
            can: None,
            allowed_db_connection_names: None,
            explores: None,
            has_content: None,
            label: None,
            name: None,
            project_name: None,
            unlimited_db_connections: None,
        }
    }
}
