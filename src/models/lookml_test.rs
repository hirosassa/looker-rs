...
pub struct LookmlTest {
    ...
    #[serde(rename = "explore_name", skip_serializing_if = "Option::is_none")]
    pub explore_name: Option<String>,
    /// The url parameters that can be used to reproduce this test's query on an explore.
    #[serde(rename = "query_url_params", skip_serializing_if = "Option::is_none")]
    pub query_url_params: Option<String>,
