...
pub struct ApiVersionElement {
    /// Version number as it appears in '/api/xxx/' urls
    #[serde(rename = "version", skip_serializing_if = "Option::is_none")]
    pub version: Option<String>,
    /// Full version number including minor version
    #[serde(rename = "full_version", skip_serializing_if = "Option::is_none")]
    pub full_version: Option<String>,
    /// Status of this version
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<String>,
    /// Url for swagger.json for this version
    #[serde(rename = "swagger_url", skip_serializing_if = "Option::is_none")]
    pub swagger_url: Option<String>,
}

impl ApiVersionElement {
    pub fn new() -> ApiVersionElement {
        ApiVersionElement {
            version: None,
            full_version: None,
            status: None,
