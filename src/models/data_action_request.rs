...
pub struct DataActionRequest {
    ...
    pub action: Option<::std::collections::HashMap<String, String>>,
    /// User input for any form values the data action might use.
    #[serde(rename = "form_values", skip_serializing_if = "Option::is_none")]
    pub form_values: Option<::std::collections::HashMap<String, String>>,
}

impl DataActionRequest {
    pub fn new() -> DataActionRequest {
        DataActionRequest {
            action: None,
            form_values: None,
        }
