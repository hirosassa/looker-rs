...
pub struct DashboardAppearance {
    /// Page margin (side) width
    #[serde(rename = "page_side_margins", skip_serializing_if = "Option::is_none")]
    pub page_side_margins: Option<i64>,
    /// Background color for the dashboard
    #[serde(rename = "page_background_color", skip_serializing_if = "Option::is_none")]
    ...
    /// Space between tiles
    #[serde(rename = "tile_space_between", skip_serializing_if = "Option::is_none")]
    pub tile_space_between: Option<i64>,
    ...
    /// Key color
    #[serde(rename = "key_color", skip_serializing_if = "Option::is_none")]
    pub key_color: Option<String>,
}

impl DashboardAppearance {
    pub fn new() -> DashboardAppearance {
        DashboardAppearance {
            page_side_margins: None,
            page_background_color: None,
            tile_title_alignment: None,
            tile_space_between: None,
