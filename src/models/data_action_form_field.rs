...
pub struct DataActionFormField {
    /// Name
    ...
    #[serde(rename = "oauth_url", skip_serializing_if = "Option::is_none")]
    ...
    pub options: Option<Vec<crate::models::DataActionFormSelectOption>>,
}

impl DataActionFormField {
    pub fn new() -> DataActionFormField {
        DataActionFormField {
            name: None,
            label: None,
            description: None,
