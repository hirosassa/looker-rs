...
pub struct LegacyFeature {
    ...
    #[serde(rename = "enabled_locally", skip_serializing_if = "Option::is_none")]
    pub enabled_locally: Option<bool>,
    /// Whether this feature is currently enabled
    #[serde(rename = "enabled", skip_serializing_if = "Option::is_none")]
    pub enabled: Option<bool>,
    /// Looker version where this feature became a legacy feature
    #[serde(rename = "disallowed_as_of_version", skip_serializing_if = "Option::is_none")]
    pub disallowed_as_of_version: Option<String>,
    /// Looker version where this feature will be automatically disabled
    #[serde(rename = "disable_on_upgrade_to_version", skip_serializing_if = "Option::is_none")]
    pub disable_on_upgrade_to_version: Option<String>,
    /// Future Looker version where this feature will be removed
    #[serde(rename = "end_of_life_version", skip_serializing_if = "Option::is_none")]
    pub end_of_life_version: Option<String>,
    ...
    #[serde(rename = "approximate_disable_date", skip_serializing_if = "Option::is_none")]
    pub approximate_disable_date: Option<String>,
    /// Approximate date that this feature will be removed.
    #[serde(rename = "approximate_end_of_life_date", skip_serializing_if = "Option::is_none")]
    pub approximate_end_of_life_date: Option<String>,
    /// Whether this legacy feature may have been automatically disabled when upgrading to the current version.
    #[serde(rename = "has_disabled_on_upgrade", skip_serializing_if = "Option::is_none")]
    pub has_disabled_on_upgrade: Option<bool>,
}

impl LegacyFeature {
    pub fn new() -> LegacyFeature {
        LegacyFeature {
            can: None,
            id: None,
            name: None,
            description: None,
            enabled_locally: None,
            enabled: None,
            disallowed_as_of_version: None,
            disable_on_upgrade_to_version: None,
            end_of_life_version: None,
            documentation_url: None,
            approximate_disable_date: None,
            approximate_end_of_life_date: None,
            has_disabled_on_upgrade: None,
        }
    }
}
