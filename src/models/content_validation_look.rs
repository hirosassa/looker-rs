...
pub struct ContentValidationLook {
    /// Unique Id
    ...
    pub folder: Option<Box<crate::models::ContentValidationFolder>>,
    #[serde(rename = "space", skip_serializing_if = "Option::is_none")]
    pub space: Option<Box<crate::models::ContentValidationSpace>>,
}

impl ContentValidationLook {
    pub fn new() -> ContentValidationLook {
