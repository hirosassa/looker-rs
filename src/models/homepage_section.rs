...
pub struct HomepageSection {
    ...
    #[serde(rename = "detail_url", skip_serializing_if = "Option::is_none")]
    pub detail_url: Option<String>,
    /// Id reference to parent homepage
    #[serde(rename = "homepage_id", skip_serializing_if = "Option::is_none")]
    pub homepage_id: Option<i64>,
    /// Items in the homepage section
    #[serde(rename = "homepage_items", skip_serializing_if = "Option::is_none")]
    pub homepage_items: Option<Vec<crate::models::HomepageItem>>,
    /// Unique Id
    ...
    #[serde(rename = "item_order", skip_serializing_if = "Option::is_none")]
    pub item_order: Option<Vec<i64>>,
    /// Name of row
    ...
    #[serde(rename = "visible_item_order", skip_serializing_if = "Option::is_none")]
    pub visible_item_order: Option<Vec<i64>>,
}

impl HomepageSection {
    pub fn new() -> HomepageSection {
        HomepageSection {
            can: None,
            created_at: None,
            deleted_at: None,
