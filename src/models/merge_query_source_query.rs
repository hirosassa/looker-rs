...
pub struct MergeQuerySourceQuery {
    /// An array defining which fields of the source query are mapped onto fields of the merge query
    #[serde(rename = "merge_fields", skip_serializing_if = "Option::is_none")]
    pub merge_fields: Option<Vec<crate::models::MergeFields>>,
    /// Display name
...
impl MergeQuerySourceQuery {
    pub fn new() -> MergeQuerySourceQuery {
