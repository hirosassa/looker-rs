...
pub struct ProjectWorkspace {
    ...
    #[serde(rename = "dependency_status", skip_serializing_if = "Option::is_none")]
    pub dependency_status: Option<String>,
    #[serde(rename = "git_branch", skip_serializing_if = "Option::is_none")]
    pub git_branch: Option<Box<crate::models::GitBranch>>,
    /// The lookml syntax used by all files in this project
    #[serde(rename = "lookml_type", skip_serializing_if = "Option::is_none")]
    pub lookml_type: Option<String>,
}
