...
pub struct DigestEmailSend {
    /// True if content was successfully generated and delivered
    #[serde(rename = "configuration_delivered", skip_serializing_if = "Option::is_none")]
    pub configuration_delivered: Option<bool>,
}

impl DigestEmailSend {
    pub fn new() -> DigestEmailSend {
        DigestEmailSend {
            configuration_delivered: None,
        }
    }
}
