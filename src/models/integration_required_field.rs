...
pub struct IntegrationRequiredField {
    ...
    #[serde(rename = "any_tag", skip_serializing_if = "Option::is_none")]
...
impl IntegrationRequiredField {
    pub fn new() -> IntegrationRequiredField {
