...
pub struct ScheduledPlanDestination {
    /// Unique Id
    #[serde(rename = "id", skip_serializing_if = "Option::is_none")]
    pub id: Option<i64>,
    /// Id of a scheduled plan you own
    #[serde(rename = "scheduled_plan_id", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "apply_formatting", skip_serializing_if = "Option::is_none")]
    pub apply_formatting: Option<bool>,
    /// Whether visualization options are applied to the results.
    #[serde(rename = "apply_vis", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "looker_recipient", skip_serializing_if = "Option::is_none")]
    pub looker_recipient: Option<bool>,
    ...
    #[serde(rename = "secret_parameters", skip_serializing_if = "Option::is_none")]
    pub secret_parameters: Option<String>,
    /// Optional message to be included in scheduled emails
    #[serde(rename = "message", skip_serializing_if = "Option::is_none")]
    pub message: Option<String>,
}

impl ScheduledPlanDestination {
    pub fn new() -> ScheduledPlanDestination {
        ScheduledPlanDestination {
            id: None,
            scheduled_plan_id: None,
            format: None,
            apply_formatting: None,
            apply_vis: None,
            address: None,
            looker_recipient: None,
            _type: None,
            parameters: None,
