...
pub struct ApiVersion {
    ...
    #[serde(rename = "looker_release_version", skip_serializing_if = "Option::is_none")]
    pub looker_release_version: Option<String>,
    #[serde(rename = "current_version", skip_serializing_if = "Option::is_none")]
    pub current_version: Option<Box<crate::models::ApiVersionElement>>,
    /// Array of versions supported by this Looker instance
    #[serde(rename = "supported_versions", skip_serializing_if = "Option::is_none")]
    pub supported_versions: Option<Vec<crate::models::ApiVersionElement>>,
    /// API server base url
    #[serde(rename = "api_server_url", skip_serializing_if = "Option::is_none")]
