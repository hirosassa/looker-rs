...
pub struct LdapConfigTestResult {
    ...
    pub issues: Option<Vec<crate::models::LdapConfigTestIssue>>,
    ...
    pub user: Option<Box<crate::models::LdapUser>>,
    /// Link to ldap config
    #[serde(rename = "url", skip_serializing_if = "Option::is_none")]
    pub url: Option<String>,
}

impl LdapConfigTestResult {
    pub fn new() -> LdapConfigTestResult {
