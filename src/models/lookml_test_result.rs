...
pub struct LookmlTestResult {
    ...
    #[serde(rename = "assertions_count", skip_serializing_if = "Option::is_none")]
    pub assertions_count: Option<i64>,
    /// Number of assertions passed in this test
    #[serde(rename = "assertions_failed", skip_serializing_if = "Option::is_none")]
    ...
    pub warnings: Option<Vec<crate::models::ProjectError>>,
    /// True if this test passsed without errors.
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
}

impl LookmlTestResult {
    pub fn new() -> LookmlTestResult {
        LookmlTestResult {
            can: None,
            model_name: None,
            test_name: None,
