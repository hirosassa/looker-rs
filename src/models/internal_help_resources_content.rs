...
pub struct InternalHelpResourcesContent {
    ...
    #[serde(rename = "markdown_content", skip_serializing_if = "Option::is_none")]
    pub markdown_content: Option<String>,
}

impl InternalHelpResourcesContent {
    pub fn new() -> InternalHelpResourcesContent {
