...
pub struct ResultMakerFilterablesListen {
    /// The name of a dashboard filter to listen to.
    #[serde(rename = "dashboard_filter_name", skip_serializing_if = "Option::is_none")]
    pub dashboard_filter_name: Option<String>,
    /// The name of the field in the filterable to filter with the value of the dashboard filter.
    #[serde(rename = "field", skip_serializing_if = "Option::is_none")]
    pub field: Option<String>,
}

impl ResultMakerFilterablesListen {
    pub fn new() -> ResultMakerFilterablesListen {
        ResultMakerFilterablesListen {
            dashboard_filter_name: None,
            field: None,
        }
    }
}
