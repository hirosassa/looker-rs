...
pub struct DashboardLayoutComponent {
    ...
    #[serde(rename = "dashboard_layout_id", skip_serializing_if = "Option::is_none")]
    pub dashboard_layout_id: Option<String>,
    /// Id Of Dashboard Element
    #[serde(rename = "dashboard_element_id", skip_serializing_if = "Option::is_none")]
    pub dashboard_element_id: Option<String>,
    /// Row
    ...
    #[serde(rename = "element_title", skip_serializing_if = "Option::is_none")]
    pub element_title: Option<String>,
    /// Whether or not the dashboard element title is displayed.
    #[serde(rename = "element_title_hidden", skip_serializing_if = "Option::is_none")]
    pub element_title_hidden: Option<bool>,
    /// Visualization type, extracted from a query's vis_config
    #[serde(rename = "vis_type", skip_serializing_if = "Option::is_none")]
    pub vis_type: Option<String>,
}

impl DashboardLayoutComponent {
    pub fn new() -> DashboardLayoutComponent {
