...
pub struct IntegrationTestResult {
    ...
    #[serde(rename = "delegate_oauth_result", skip_serializing_if = "Option::is_none")]
    pub delegate_oauth_result: Option<Vec<crate::models::DelegateOauthTest>>,
}

impl IntegrationTestResult {
    pub fn new() -> IntegrationTestResult {
        IntegrationTestResult {
            success: None,
            message: None,
            delegate_oauth_result: None,
        }
    }
}
