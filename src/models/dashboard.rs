...
pub struct Dashboard {
    ...
    #[serde(rename = "alert_sync_with_dashboard_filter_enabled", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "crossfilter_enabled", skip_serializing_if = "Option::is_none")]
