...
pub struct Manifest {
    ...
    pub imports: Option<Vec<crate::models::ImportedProject>>,
    #[serde(rename = "localization_settings", skip_serializing_if = "Option::is_none")]
    pub localization_settings: Option<Box<crate::models::LocalizationSettings>>,
}
